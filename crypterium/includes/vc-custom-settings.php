...
if ( ! function_exists( 'vc_set_as_theme' ) OR  ! function_exists( 'vc_frontend_editor' ) )
return false;

//FOR ROW EXTRA ATTR
$crypterium_background_one_attributes = array(
    array(
        'type' => 'dropdown',
        'heading' => esc_html__('Theme parallax(jarallax)', 'crypterium' ),
        'param_name' => 'crypterium_vc_row_jarallax',
        'description' => esc_html__('You can select yes if you want to use theme parallax. You need to add an image on design options tab ', 'crypterium'),
        'group' => esc_html__('Crypterium','crypterium'),
        'value' => array(
    ...
    array(
        'type' => 'textfield',
        'heading' => esc_html__('Parallax speed', 'crypterium'),
        'param_name' => 'crypterium_vc_row_jarallax_speed',
        'description' => esc_html__('You can use numbers, example : 0.3', 'crypterium'),
        'group' => esc_html__('Crypterium', 'crypterium' ),
    ),
    array(
        'type' => 'attach_image',
    ...
    array(
        'type' => 'dropdown',
        'heading' => esc_html__('Row overflow option', 'crypterium' ),
        'param_name' => 'crypterium_vc_row_overflow',
        'description' => esc_html__('You can select visible if your bottom item not showing correctly', 'crypterium'),
        'group' => esc_html__('Crypterium', 'crypterium' ),
        'weight' => -1,
        'value' => array(
            esc_html__('Select options', 'crypterium' ) => '',
            esc_html__('Overflow-hidden', 'crypterium' ) => 'hidden',
            esc_html__('Overflow-visible', 'crypterium' ) => 'visible',
        ),
    ),
    array(
        'type' => 'dropdown',
        'heading' => esc_html__('Theme section classes', 'crypterium' ),
        'param_name' => 'crypterium_row_classess',
    ...
    array(
        ...
        'param_name' => 'crypterium_row_bg_classess',
        'description' => esc_html__('You can select an option for default section paddings', 'crypterium'),
        'group' => esc_html__('Crypterium', 'crypterium' ),
        'weight' => -3,
        'value' => array(
    ...
    array(
        'type' => 'dropdown',
        'heading' => esc_html__('Background position Y-X axis', 'crypterium' ),
        'param_name' => 'crypterium_bg_position',
        'description' => esc_html__('Change position Y-X axis for bg image.', 'crypterium'),
        'group' => esc_html__('Design Options','crypterium'),
        'value' => array(
            esc_html__('Select Y-X position', 'crypterium' ) => '',
            esc_html__('Left-Top', 'crypterium' ) => 'left top',
            esc_html__('Left-Center', 'crypterium' ) => 'left center',
            esc_html__('Left-Bottom', 'crypterium' ) => 'left bottom',
            esc_html__('Right-Top', 'crypterium' ) => 'right top',
            esc_html__('Right-Center', 'crypterium' ) => 'right center',
            esc_html__('Right-Bottom', 'crypterium' ) => 'right bottom',
            esc_html__('Center-Top', 'crypterium' ) => 'center top',
            esc_html__('Center-Center', 'crypterium' ) => 'center center',
            esc_html__('Center-Bottom', 'crypterium' ) => 'center bottom',
    ...
    array(
        'type' => 'textfield',
        'heading' => esc_html__('Background position Y axis', 'crypterium'),
        'param_name' => 'crypterium_bg_positiony',
        'description' => esc_html__('Change position X axis offset for bg image.example: center or 40px or 25% ...etc', 'crypterium'),
        'group' => esc_html__('Design Options','crypterium'),
        'dependency' => array(
            'element' => 'crypterium_bg_position',
            'value' => 'custom'
        )
    ),
    array(
        'type' => 'textfield',
        'heading' => esc_html__('Background position X axis', 'crypterium'),
        'param_name' => 'crypterium_bg_positionx',
        'description' => esc_html__('Change position X axis offset for bg image.example: center or 40px or 25% ...etc', 'crypterium'),
        'group' => esc_html__('Design Options','crypterium'),
        'dependency' => array(
            'element' => 'crypterium_bg_position',
    ...
    array(
        'type' => 'textfield',
        'heading' => esc_html__('Background position X axis offset', 'crypterium'),
        'param_name' => 'crypterium_bg_xoffset',
        'description' => esc_html__('Change position X axis offset for bg image.example: 40px or 25% ...etc', 'crypterium'),
        'group' => esc_html__('Design Options','crypterium'),
        'dependency' => array(
            'element' => 'crypterium_bg_position',
            'value' => 'custom'
    ...
    array(
        'type' => 'textfield',
        'heading' => esc_html__('Background size', 'crypterium'),
        'param_name' => 'crypterium_bg_size',
        'description' => esc_html__('Change size for bg image.example: 100px or 100% or 100vh', 'crypterium'),
        'group' => esc_html__('Design Options','crypterium'),
    ),
    array(
        'type' => 'dropdown',
        'heading' => esc_html__('Background image display ( under 992px )', 'crypterium' ),
        'param_name' => 'crypterium_bg_ontablet',
        'description' => esc_html__('You can select show or hide background image under 992px', 'crypterium'),
        'group' => esc_html__('Design Options','crypterium'),
        'value' => array(
            esc_html__('Select options', 'crypterium' ) => '',
    ...
    array(
        'type' => 'dropdown',
        'heading' => esc_html__('Background image display ( under 768px )', 'crypterium' ),
        'param_name' => 'crypterium_bg_onmobile',
        'description' => esc_html__('You can select show or hide background image under 768px', 'crypterium'),
        'group' => esc_html__('Design Options','crypterium'),
        'value' => array(
            esc_html__('Select options', 'crypterium' ) => '',
            esc_html__('Show', 'crypterium' ) => 'show',
    ...
    array(
        'type' => 'dropdown',
        'heading' => esc_html__('Background image display ( under 480px )', 'crypterium' ),
        'param_name' => 'crypterium_bg_onphone',
        'description' => esc_html__('You can select show or hide background image under 480px', 'crypterium'),
        'group' => esc_html__('Design Options','crypterium'),
        'value' => array(
            esc_html__('Select options', 'crypterium' ) => '',
            esc_html__('Show', 'crypterium' ) => 'show',
...
vc_add_params( 'vc_row', $crypterium_background_one_attributes );


//FOR ROW 480 RESOLUTION
$crypterium_vc_row_responsive_attributes = array(

    array(
        'type' => 'css_editor',
        'heading' => esc_html__( 'Max width 992px resolution', 'crypterium' ),
        'param_name' => 'crypterium_vc_row_992_responsive',
        'description' => esc_html__( 'These options for 992px resolution - responsive medya', 'crypterium' ),
        'group' => esc_html__('Responsive','crypterium'),
    ),
    array(
        'type' => 'css_editor',
        'heading' => esc_html__( 'Max width 768px resolution', 'crypterium' ),
        'param_name' => 'crypterium_vc_row_768_responsive',
        'description' => esc_html__( 'These options for 768px resolution - responsive medya', 'crypterium' ),
        'group' => esc_html__('Responsive','crypterium'),
    ),
    array(
        'type' => 'css_editor',
        'heading' => esc_html__( 'Max width 480px resolution', 'crypterium' ),
        'param_name' => 'crypterium_vc_row_480_responsive',
        'description' => esc_html__( 'These options for 480px resolution - responsive medya', 'crypterium' ),
        'group' => esc_html__('Responsive','crypterium'),
    ),

);
vc_add_params( 'vc_row', $crypterium_vc_row_responsive_attributes );


//FOR ROW EXTRA 3 OVERLAY ATTR
$crypterium_row_overlay_attributes = array(

    //OVERLAY 1
    array(
        'type' => 'colorpicker',
        'heading' => esc_html__('Overlay Color', 'crypterium'),
        'param_name' => 'overlaybg',
        'description' => esc_html__('Add color.', 'crypterium'),
        'group' => esc_html__('Overlay 1','crypterium'),
    ),
    array(
        'type' => 'textfield',
        'heading' => esc_html__('Width', 'crypterium'),
        'param_name' => 'overlaywidth',
        'description' => esc_html__('Add width.example:100% or 75%....etc.', 'crypterium'),
        'group' => esc_html__('Overlay 1','crypterium'),
    ),
    array(
        'type' => 'textfield',
        'heading' => esc_html__('Height', 'crypterium'),
    ...
    array(
        'type' => 'textfield',
        'heading' => esc_html__('Top offset', 'crypterium'),
        'param_name' => 'overlaytop',
        'description' => esc_html__('Add Top offset for top position.example:10px or 10%.', 'crypterium'),
        'group' => esc_html__('Overlay 1','crypterium'),
    ),
    array(
        'type' => 'textfield',
        'heading' => esc_html__('Left offset', 'crypterium'),
        'param_name' => 'overlayleft',
        'description' => esc_html__('Add left offset for left position.example:10px or 10%.', 'crypterium'),
        'group' => esc_html__('Overlay 1','crypterium'),
    ),
    array(
        'type' => 'textfield',
        'heading' => esc_html__('Right offset', 'crypterium'),
        'param_name' => 'overlayright',
        'description' => esc_html__('Add right offset for right position.example:10px or 10%.', 'crypterium'),
        'group' => esc_html__('Overlay 1','crypterium'),
    ),
    array(
        'type' => 'textfield',
        'heading' => esc_html__('Bottom offset', 'crypterium'),
        'param_name' => 'overlaybottom',
        'description' => esc_html__('Add bottom offset for bottom position.example:10px or 10%.', 'crypterium'),
        'group' => esc_html__('Overlay 1','crypterium'),
    ),
    array(
        'type' => 'dropdown',
        'heading' => esc_html__('Display under 992px', 'crypterium' ),
        'param_name' => 'overlay992',
        'description' => esc_html__('You can select show or hide overlay and underlay color maximum device width 992px', 'crypterium' ),
        'group' => esc_html__('Overlay 1', 'crypterium' ),
        'value' => array(
    ...
    array(
        'type' => 'dropdown',
        'heading' => esc_html__('Display under 768px', 'crypterium' ),
        'param_name' => 'overlay768',
        'description' => esc_html__('You can select show or hide overlay and underlay color maximum device width 768px', 'crypterium' ),
        'group' => esc_html__('Overlay 1', 'crypterium' ),
        'value' => array(
            esc_html__('Select position', 'crypterium' ) => '',
            esc_html__('Show', 'crypterium' ) => 'show',
    ...
    array(
        'type' => 'dropdown',
        'heading' => esc_html__('Display under 480px', 'crypterium' ),
        'param_name' => 'overlay480',
        'description' => esc_html__('You can select show or hide overlay and underlay color maximum device width 480px', 'crypterium' ),
        'group' => esc_html__('Overlay 1', 'crypterium' ),
        'value' => array(
            esc_html__('Select position', 'crypterium' ) => '',
            esc_html__('Show', 'crypterium' ) => 'show',
    ...
    array(
        ...
        'description' => esc_html__('Add color.', 'crypterium'),
        'group' => esc_html__('Overlay 2','crypterium'),
    ),
    array(
        'type' => 'textfield',
        'heading' => esc_html__('Width', 'crypterium'),
...
vc_add_params( 'vc_row', $crypterium_row_overlay_attributes );

//FOR COLUMN
$crypterium_vc_column_responsive_attributes = array(

    array(
        'type' => 'css_editor',
        'heading' => esc_html__( 'Max width 992px resolution', 'crypterium' ),
        'param_name' => 'crypterium_vc_column_992',
        'description' => esc_html__( 'These options for 992px resolution - responsive medya', 'crypterium' ),
        'group' => esc_html__('Responsive Extra','crypterium'),
    ),
    array(
        'type' => 'css_editor',
        'heading' => esc_html__( 'Max width 768px resolution', 'crypterium' ),
        'param_name' => 'crypterium_vc_column_768',
        'description' => esc_html__( 'These options for 768px resolution - responsive medya', 'crypterium' ),
        'group' => esc_html__('Responsive Extra','crypterium'),
    ),
    array(
        'type' => 'css_editor',
        'heading' => esc_html__( 'Max width 480px resolution', 'crypterium' ),
        'param_name' => 'crypterium_vc_column_480',
        'description' => esc_html__( 'These options for 480px resolution - responsive medya', 'crypterium' ),
        'group' => esc_html__('Responsive Extra','crypterium'),
    ),
    array(
        ...
        'param_name' => 'crypterium_vc_column_aos',
        'description' => esc_html__( 'You can add your aos data, example : data-aos="zoom-in" data-aos-delay="100" data-aos-offset="100" ', 'crypterium' ),
        'group' => esc_html__('Animate','crypterium'),
    ),

);
vc_add_params( 'vc_column', $crypterium_vc_column_responsive_attributes );

//FOR COLUMN INNER
$crypterium_vc_column_inner_responsive_attributes = array(

    array(
        'type' => 'css_editor',
        'heading' => esc_html__( 'Max width 992px resolution', 'crypterium' ),
        'param_name' => 'crypterium_vc_colinner_992',
        'description' => esc_html__( 'These options for 992px resolution - responsive medya', 'crypterium' ),
        'group' => esc_html__('Responsive Extra','crypterium'),
    ),
    array(
        'type' => 'css_editor',
        'heading' => esc_html__( 'Max width 768px resolution', 'crypterium' ),
        'param_name' => 'crypterium_vc_colinner_768',
        'description' => esc_html__( 'These options for 768px resolution - responsive medya', 'crypterium' ),
        'group' => esc_html__('Responsive Extra','crypterium'),
    ),
    array(
        'type' => 'css_editor',
        'heading' => esc_html__( 'Max width 480px resolution', 'crypterium' ),
        'param_name' => 'crypterium_vc_colinner_480',
        'description' => esc_html__( 'These options for 480px resolution - responsive medya', 'crypterium' ),
        'group' => esc_html__('Responsive Extra','crypterium'),
    ),
    array(
        'type' => 'textfield',
        'heading' => esc_html__( 'AOS animate', 'crypterium' ),
        'param_name' => 'crypterium_vc_column_inner_aos',
        'description' => esc_html__( 'You can add your aos data, example : data-aos="zoom-in" data-aos-delay="100" data-aos-offset="100" ', 'crypterium' ),
        'group' => esc_html__('Animate','crypterium'),
    ),

);
vc_add_params( 'vc_column_inner', $crypterium_vc_column_inner_responsive_attributes );

//FOR COLUMN INNER
$crypterium_vc_single_img_attributes = array(
    ...
    array(
        ...
        'description' => esc_html__('Add color.', 'crypterium'),
        'group' => esc_html__('Extras 1','crypterium'),
    ),
    array(
        'type' => 'textfield',
        'heading' => esc_html__('z-index', 'crypterium'),
        'param_name' => 'ntzindex',
        'description' => esc_html__('Add z-index. example: 1', 'crypterium'),
        'group' => esc_html__('Extras 1','crypterium'),
    ),
    array(
        'type' => 'textfield',
    ...
    array(
        'type' => 'colorpicker',
        'heading' => esc_html__('Underlay Color', 'crypterium'),
        'param_name' => 'ntbgcolor2',
        'description' => esc_html__('Add color.', 'crypterium'),
        'group' => esc_html__('Extras 2','crypterium'),
    ),
    array(
        'type' => 'textfield',
        'heading' => esc_html__('z-index', 'crypterium'),
        'param_name' => 'ntzindex2',
        'description' => esc_html__('Add z-index. example: 0, -1, 1', 'crypterium'),
        'group' => esc_html__('Extras 2','crypterium'),
    ),
    array(
        'type' => 'textfield',
...
vc_add_params( 'vc_single_image', $crypterium_vc_single_img_attributes );

//FOR CUSTOM HEADING
$crypterium_vc_custom_heading = array(
    array(
        'type' => 'dropdown',
        'heading' => esc_html__('Theme heading types', 'crypterium' ),
        'param_name' => 'crypterium_chc',
        'description' => esc_html__('You can select an option for using general theme heading types', 'crypterium' ),
        'group' => esc_html__('Crypterium Styles ', 'crypterium' ),
        'value' => array(
            esc_html__('Select a type', 'crypterium' ) => '',
            esc_html__('Hero', 'crypterium' ) => 'u-text-hero',
            esc_html__('Title', 'crypterium' ) => 'u-text-title',
            esc_html__('Lead', 'crypterium' ) => 'u-text-lead',
            esc_html__('Sup', 'crypterium' ) => 'u-text-sup',
            esc_html__('Large', 'crypterium' ) => 'u-text-large',
            esc_html__('Justify', 'crypterium' ) => 'u-text-justify',
            esc_html__('Nowrap', 'crypterium' ) => 'u-text-nowrap',
            esc_html__('Truncate', 'crypterium' ) => 'u-text-truncate',
            esc_html__('Break', 'crypterium' ) => 'u-text-break',
            esc_html__('Break All', 'crypterium' ) => 'u-text-break-all',
            esc_html__('Lowercase', 'crypterium' ) => 'u-text-lowercase',
            esc_html__('Capitalize','crypterium' ) => 'u-text-capitalize',
        ),
    ),
    array(
        'type' => 'dropdown',
        'heading' => esc_html__('Theme colors', 'crypterium' ),
        'param_name' => 'crypterium_chcolor',
        'description' => esc_html__('You can select an option for using general theme colors', 'crypterium' ),
        'group' => esc_html__('Crypterium Styles ', 'crypterium' ),
        'value' => array(
            esc_html__('Select a type', 'crypterium' ) => '',
            esc_html__('White', 'crypterium' ) => 'u-color-white',
            esc_html__('Black', 'crypterium' ) => 'u-color-black',
            esc_html__('Green', 'crypterium' ) => 'u-color-green',
            esc_html__('Red', 'crypterium' ) => 'u-color-red',
            esc_html__('Blue', 'crypterium' ) => 'u-color-blue',
            esc_html__('Orange', 'crypterium' ) => 'u-color-orange',
        ),
    ),
);
vc_add_params( 'vc_custom_heading', $crypterium_vc_custom_heading );
//FOR CUSTOM HEADING
$crypterium_vc_empty_space = array(
    array(
        'type' => 'dropdown',
        'heading' => esc_html__('Theme space types', 'crypterium' ),
        'param_name' => 'crypterium_vc_space',
        'description' => esc_html__('You can select an option for using general theme heading types', 'crypterium' ),
        'group' => esc_html__('Crypterium Styles ', 'crypterium' ),
        'value' => array(
            esc_html__('Select a type', 'crypterium' ) => '',
            esc_html__('20px Top-Bottom - xsmall', 'crypterium' ) => 'c-section -space-xsmall',
            esc_html__('20px Top - xsmall', 'crypterium' ) => 'c-section -space-xsmall-top',
            esc_html__('20px Bottom - xsmall', 'crypterium' ) => 'c-section -space-xsmall-bottom',
            esc_html__('50px Top-Bottom - small', 'crypterium' ) => 'c-section -space-small',
            esc_html__('50px Top - small', 'crypterium' ) => 'c-section -space-small-top',
            esc_html__('50px Bottom - small', 'crypterium' ) => 'c-section -space-small-bottom',
            esc_html__('100px Top-Bottom - medium', 'crypterium' ) => 'c-section -space-medium',
            esc_html__('100px Top - medium', 'crypterium' ) => 'c-section -space-medium-top',
            esc_html__('100px Bottom - medium', 'crypterium' ) => 'c-section -space-medium-bottom',
            esc_html__('120px Top-Bottom - large', 'crypterium' ) => 'c-section -space-large',
            esc_html__('120px Top - large', 'crypterium' ) => 'c-section -space-large-top',
            esc_html__('120px Bottom - large', 'crypterium' ) => 'c-section -space-large-bottom',
            esc_html__('10px Space', 'crypterium' ) => 'u-space u-space-10@sm',
            esc_html__('20px Space', 'crypterium' ) => 'u-space u-space-20@sm',
            esc_html__('30px Space', 'crypterium' ) => 'u-space u-space-30@sm',
            esc_html__('40px Space', 'crypterium' ) => 'u-space u-space-40@sm',
            esc_html__('50px Space', 'crypterium' ) => 'u-space u-space-50@sm',
            esc_html__('60px Space', 'crypterium' ) => 'u-space u-space-60@sm',
            esc_html__('70px Space', 'crypterium' ) => 'u-space u-space-70@sm',
            esc_html__('80px Space', 'crypterium' ) => 'u-space u-space-80@sm',
            esc_html__('90px Space', 'crypterium' ) => 'u-space u-space-90@sm',
            esc_html__('100px Space', 'crypterium' ) => 'u-space u-space-100@sm',
            esc_html__('120px Space', 'crypterium' ) => 'u-space u-space-120@sm',
        ),
    ),
);
vc_add_params( 'vc_empty_space', $crypterium_vc_empty_space );


// Visual composer

function crypterium_add_cta_button_theme_color() {
    //Get current values stored in the color param in "Button" element
    $param = WPBMap::getParam( 'vc_btn', 'style' );
    //Append new value to the 'value' array
    $param['value'][__( 'Crypterium read more', 'crypterium' )] = 'crypterium-default-btn';
    //Finally "mutate" param with new values
    vc_update_shortcode_param( 'vc_btn', $param );

    //Get current values stored in the color param in "Button" element
    $param1 = WPBMap::getParam( 'vc_btn', 'color' );
    //Append new value to the 'value' array
    $param1['value'][__( 'Crypterium read more', 'crypterium' )] = 'crypterium-default-btn';
    //Finally "mutate" param with new values
    vc_update_shortcode_param( 'vc_btn', $param1 );

    //Get current values stored in the color param in "Call to Action" element
    $param2 = WPBMap::getParam( 'vc_btn', 'color' );
    //Append new value to the 'value' array
    $param2['value'][__( 'Crypterium green', 'crypterium' )] = 'crypterium-green-btn';
    //Finally "mutate" param with new values
    vc_update_shortcode_param( 'vc_btn', $param2 );
}
add_action( 'vc_after_init', 'crypterium_add_cta_button_theme_color' ); /* Note: here we are using vc_after_init because WPBMap::GetParam and mutateParame are available only when default content elements are "mapped" into the system */

// Add new custom font to Font Family selection in icon box module
function crypterium_add_ionicons( ) {
    $param = WPBMap::getParam( 'vc_icon', 'type' );
    $param['value'][__( 'Ionicons', 'crypterium' )] = 'ionicons';
    vc_update_shortcode_param( 'vc_icon', $param );
    $param1 = WPBMap::getParam( 'vc_icon', 'size' );
    $param1['value'][__( 'Theme size', 'crypterium' )] = 'c-summary-1-icon';
    vc_update_shortcode_param( 'vc_icon', $param1 );
}
add_filter( 'init', 'crypterium_add_ionicons', 40 );
// Add font picker setting to icon box module when you select your font family from the dropdown
function crypterium_add_font_picker() {
...
add_filter( 'vc_after_init', 'crypterium_add_font_picker', 40 );
// Add array of your fonts so they can be displayed in the font selector
function crypterium_icon_array() {
    return array(
...
add_filter( 'vc_iconpicker-type-ionicons', 'crypterium_icon_array' );
/**
* Register Backend and Frontend CSS Styles
*/
add_action( 'vc_base_register_front_css', 'crypterium_vc_iconpicker_base_register_css' );
add_action( 'vc_base_register_admin_css', 'crypterium_vc_iconpicker_base_register_css' );
function crypterium_vc_iconpicker_base_register_css(){
    wp_register_style('ionicons', get_template_directory_uri() . '/framework/css/ionicon-stylesheet.css');
}
/**
* Enqueue Backend and Frontend CSS Styles
*/
add_action( 'vc_backend_editor_enqueue_js_css', 'crypterium_vc_iconpicker_editor_jscss' );
add_action( 'vc_frontend_editor_enqueue_js_css', 'crypterium_vc_iconpicker_editor_jscss' );
function crypterium_vc_iconpicker_editor_jscss(){
    wp_enqueue_style( 'ionicons' );
}
/**
* Enqueue CSS in Frontend when it's used
*/
add_action('vc_enqueue_font_icon_element', 'crypterium_enqueue_font_ionicons');
function crypterium_enqueue_font_ionicons($font){
    switch ( $font ) {
